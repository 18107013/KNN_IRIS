...
NumberOfSections = st.number_input('NumberOfSections',min_value=xmin[1],max_value=xmax[1],value=50,step=1)
CreationYear = st.number_input('CreationYear',min_value=xmin[2],max_value=xmax[2],value=50,step=1)
...
MajorLinkerVersion = st.number_input('MajorLinkerVersion',min_value=xmin[6],max_value=xmax[6],value=50,step=1)
MinorLinkerVersion = st.number_input('MinorLinkerVersion',min_value=xmin[7],max_value=xmax[7],value=50,step=1)
ImageBase = st.number_input('ImageBase',min_value=xmin[8],max_value=xmax[8],value=50,step=1)
...
MajorOperatingSystemVersion = st.number_input('"MajorOperatingSystemVersion',min_value=xmin[11],max_value=xmax[11],value=50,step=1)
...
MajorSubsystemVersion= st.number_input('MajorSubsystemVersion',min_value=xmin[15],max_value=xmax[15],value=50,step=1)
MinorSubsystemVersion= st.number_input('MinorSubsystemVersion',min_value=xmin[16],max_value=xmax[16],value=50,step=1)
SizeOfHeaders= st.number_input('SizeOfHeaders',min_value=xmin[17],max_value=xmax[17],value=50,step=1)
CheckSum = st.number_input('CheckSum',min_value=xmin[18],max_value=xmax[18],value=60601,step=1)
Subsystem = st.number_input('Subsystem',min_value=xmin[19],max_value=xmax[19],value=50,step=1)
DllCharacteristics = st.number_input('DllCharacteristics',min_value=xmin[20],max_value=xmax[20],value=50,step=1)
SizeOfStackReserve= st.number_input('SizeOfStackReserve',min_value=xmin[21],max_value=xmax[21],value=50,step=1)
SizeOfStackCommit= st.number_input('SizeOfStackCommit',min_value=xmin[22],max_value=xmax[22],value=50,step=1)
SizeOfHeapReserve= st.number_input('SizeOfHeapReserve',min_value=xmin[23],max_value=xmax[23],value=50,step=1)
SizeOfHeapCommit= st.number_input('SizeOfHeapCommit',min_value=xmin[24],max_value=xmax[24],value=50,step=1)
