...
SectionAlignment = st.number_input('SectionAlignment',min_value=xmin[9],max_value=xmax[9],value=5,step=1)
FileAlignment = st.number_input('FileAlignment',min_value=xmin[10],max_value=xmax[10],value=5,step=1)
MajorOperatingSystemVersion = st.number_input('"MajorOperatingSystemVersion',min_value=xmin[11],max_value=xmax[11],value=5,step=1)
MinorOperatingSystemVersion = st.number_input('MinorOperatingSystemVersion',min_value=xmin[12],max_value=xmax[12],value=5,step=1)
MajorImageVersion= st.number_input('MajorImageVersion',min_value=xmin[13],max_value=xmax[13],value=5,step=1)
MinorImageVersion= st.number_input('MinorImageVersion',min_value=xmin[14],max_value=xmax[14],value=5,step=1)
MajorSubsystemVersion= st.number_input('MajorSubsystemVersion',min_value=xmin[15],max_value=xmax[15],value=5,step=1)
MinorSubsystemVersion= st.number_input('MinorSubsystemVersion',min_value=xmin[16],max_value=xmax[16],value=5,step=1)
SizeOfHeaders= st.number_input('SizeOfHeaders',min_value=xmin[17],max_value=xmax[17],value=5,step=1)
CheckSum = st.number_input('CheckSum',min_value=xmin[18],max_value=xmax[18],value=5,step=1)
Subsystem = st.number_input('Subsystem',min_value=xmin[19],max_value=xmax[19],value=5,step=1)
DllCharacteristics = st.number_input('DllCharacteristics',min_value=xmin[20],max_value=xmax[20],value=5,step=1)
SizeOfStackReserve= st.number_input('SizeOfStackReserve',min_value=xmin[21],max_value=xmax[21],value=5,step=1)
SizeOfStackCommit= st.number_input('SizeOfStackCommit',min_value=xmin[22],max_value=xmax[22],value=5,step=1)
SizeOfHeapReserve= st.number_input('SizeOfHeapReserve',min_value=xmin[23],max_value=xmax[23],value=5,step=1)
SizeOfHeapCommit= st.number_input('SizeOfHeapCommit',min_value=xmin[24],max_value=xmax[24],value=5,step=1)
LoaderFlags = st.number_input('LoaderFlags',min_value=xmin[25],max_value=xmax[25],value=5,step=1)
